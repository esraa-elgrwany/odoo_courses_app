...
class StateRow extends StatefulWidget {
  ...
  final void Function(StateResult) onSave;
...
class _StateRowState extends State<StateRow> {
  ...
  void initState() {
    super.initState();
    selectedStateName = widget.initialValue;
  }
  ...
  void _showStateSelectionDialog() {
    showDialog(
      ...
      builder: (context) => BlocProvider(
        ...
        child: StateDialog(
          onStateSelected: (StateResult newState) {
            setState(() {
              selectedState = newState;
              selectedStateName = newState.name!;
              hasChanged = true;
            });
          },
        ),
